package com.syz.springcloud.hystrix.hystrixcustomthreadpoolway;
...
//    我们只需要重写getThreadPool方法即可完成对线程池的改造，由于TtlExecutors只能修饰ExecutorService和Executor，
//    而HystrixConcurrencyStrategy中返回的是ThreadPoolExecutor，我们需要对ThreadPoolExecutor进行包装一层，
//    最终在execute方法中对线程修饰，也就相当于改造了线程池。
    //最后在app启动类中添加注册自定义线程池
